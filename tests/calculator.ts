...
describe("calculator", () => {
  ...
  //test out Subtraction
  it('Subtraction',async () => {
    await program.methods.subtraction(new anchor.BN(3), new anchor.BN(2))
    .accounts({
        calculator: calculatorPair.publicKey,
    })
    .rpc()
  ...
  it('Multiplication',async () => {
    await program.methods.multiplication(new anchor.BN(2), new anchor.BN(3))
    .accounts({
        calculator: calculatorPair.publicKey,
    })
    .rpc()
